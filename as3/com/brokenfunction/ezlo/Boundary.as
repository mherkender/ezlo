...
package com.brokenfunction.ezlo {
	public interface Boundary extends Position {
		function get x1():Number;
		function get y1():Number;
		function get x2():Number;
		function get y2():Number;
		function set x1(x:Number):void;
		function set y1(y:Number):void;
		function set x2(x:Number):void;
		function set y2(y:Number):void;
	}
}